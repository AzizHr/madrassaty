...
public class StudentAuthController {
    ...
    public ResponseEntity<RegisterResponse> register(@Valid @ModelAttribute StudentRegisterDTO studentRegisterDTO) throws NotFoundException, IOException, EmailAlreadyInUseException {
