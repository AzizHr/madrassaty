...
public class TeacherAuthController {
    ...
    public ResponseEntity<RegisterResponse> register(@Valid @ModelAttribute TeacherRegisterDTO teacherRegisterDTO) throws NotFoundException, IOException, EmailAlreadyInUseException {
